      ...
      <tr>
        <td width="100px" align="center" style="border: 1px solid transparent; padding: 8px;">
          ...
          <a href="https://langchain.com/" target="_blank" rel="noreferrer">
            <img height="128px" src="https://registry.npmmirror.com/@lobehub/icons-static-svg/latest/files/icons/langchain-color.svg" alt="LangChain" />
          </a>
        </td>
        <td width="100px" align="center" style="border: 1px solid transparent; padding: 8px;">
          LangGraph<br>
          <a href="https://langchain-ai.github.io/langgraph/" target="_blank" rel="noreferrer">
            <img height="128px" src="https://registry.npmmirror.com/@lobehub/icons-static-svg/latest/files/icons/langgraph-color.svg" alt="LangGraph" />
          </a>
        </td>
        <td width="100px" align="center" style="border: 1px solid transparent; padding: 8px;">
          MCP<br>
